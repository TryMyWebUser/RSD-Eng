                ...
                <div class="col-auto align-items-center d-md-flex">
                    <span class="icon-text d-inline-flex align-items-center">
                        ...
                        <span>
                            ...
                            <a href="https://wa.me/9443478449">+91 9443478449</a>
                        </span>
                    </span>
                    <span class="icon-text d-inline-flex align-items-center">
                        <i class="icofont-phone"></i>
    ...
    <div class="header-fixed">
        <div class="container">
            <nav class="navbar navbar-expand-lg btco-hover-menu bg-sky-blue rounded-top">
                ...
                <span class="light-social-icons order-lg-last" style="margin-right: 1rem;">
                    <a href="#"><i class="icofont-facebook"></i></a>
                    <a href="#"><i class="icofont-instagram"></i></a>
                    <a href="https://wa.me/9443478449"><i class="icofont-whatsapp"></i></a>
                ...
                <div class="collapse navbar-collapse mainmenu" id="navbarCollapse" data-hover="dropdown">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Errection <i class="icofont-rounded-down"></i></a>
                            <ul class="dropdown-menu">
