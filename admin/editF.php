<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST')
    {
        ...
        if (isset($_POST['submit']) && isset($_POST['title']) && isset($_POST['category']))
        {
            ...
            $error = User::updateFabs($name, $img, $cate, $getID, $conn);
        }
    }
?>
                            ...
                            <div class="rounded h-100 p-4">
                                ...
                                <form method="POST" enctype="multipart/form-data">
                                    <select class="form-select mb-3" name="category" required>
                                        <option value="<?= $pro['category'] ?>">Select Fabrication Category *</option>
                                        <?php
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Title" value="<?= $pro['name']; ?>" required>
                                    </div>
